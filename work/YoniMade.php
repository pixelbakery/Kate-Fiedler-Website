            ...
            <div class="col-12 col-md-9">
                <div class="row">
                    ...
                    <div class="col-12 margin-bottom-20">
                        <a data-fancybox="gallery" href="../../assets/images/work/yonimade_full_logo01.jpg"><img src="../../assets/images/work/yonimade_full_logo01.jpg"></a>
                    ...
                    <div class="col-12 col-lg-8 margin-bottom-20">
                        ...
                        <p itemprop="description"><b>Category:</b> Logo  / Product  / Print Design</p><br/>
                        <p itemprop="articleBody">Yoni Made Co. is a luxury goods brand that produces handcrafted wooden products. Yoni Made wanted a fresh, new logo for the brand. They wanted the look of the design to feel organic, yet have a sense of consciousness to the environment.   </p><br/>
                    ...
                    <div class="col-12 col-md-6  pt-2">
                        ...
                        <a data-fancybox="gallery" href="../../assets/images/work/yoni_packagingtape_max.jpg"> 
                            <img src="../../assets/images/work/yoni_packagingtape.jpg" alt="Yoni Made tape" / class="imageHover"> 
                        </a>
                        <!-- END IMAGE ZOOM -->
                        
                    </div> 
                     <div class="col-12 col-md-6  pt-2">
                         <a data-fancybox="gallery" href="../../assets/images/work/yoni_thankyoucards02.jpg"> 
                            <img src="../../assets/images/work/yoni_thankyoucards.jpg" alt="Yoni Made card design" />
                        </a>
                    </div> 
